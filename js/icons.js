/**
 * SECUREDEAL — Bibliothèque d'icônes SVG
 * Icônes inline optimisées, sans dépendance externe
 */

const Icons = {
  shield: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 L20 5.5 V12 C20 17 16.5 21 12 23 C7.5 21 4 17 4 12 V5.5 Z"/><polyline points="8.5 12 11 14.5 15.5 9.5"/></svg>`,
  ...
  qr: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="3" height="3"/><path d="M17 14h.01M20 14v3M20 20h-3M17 20v.01"/></svg>`,
  ...
  euro: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10h12M4 14h12M15.5 4c-1.6 0-3.1.5-4.3 1.4C9.9 6.6 9 8.2 9 10s.9 3.4 2.2 4.6C12.4 15.5 13.9 16 15.5 16"/></svg>`,
  ...
  car: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v9a2 2 0 0 1-2 2h-2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M14 3v4h5"/></svg>`,
  ...
  starFull: `<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`,
  ...
  /** Retourne le HTML d'une icône avec taille */
  get(name, size = 20, className = '') {
    if (!this[name]) return '';
    return `<span class="icon ${className}" style="width:${size}px;height:${size}px;display:inline-flex;align-items:center">${this[name]}</span>`;
  },
};
